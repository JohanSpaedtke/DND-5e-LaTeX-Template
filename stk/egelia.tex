...
\begin{monsterboxnobg}{Deer}
	...
	\monstersection{Actions}
	\begin{monsteraction}[Bite]
		\textit{Melee Weapon Attack:} +2 to hit, reach 5ft., one target. \textit{Hit:} 2 (1d4) piercing damage.
	\end{monsteraction}
\end{monsterboxnobg}
...
\begin{monsterboxnobg}{Giant Fire Beetle}
	...
	\monstersection{Actions}
	\begin{monsteraction}[Bite]
		\textit{Melee Weapon Attack:} +1 to hit, reach 5ft., one target. \textit{Hit:} 2 (1d6 - 1) slashing damage.
	\end{monsteraction}
